                    ...
                    child: Padding(
                      ...
                      child: wide
                              ...
                              children: [
                                const Expanded(
                                  ...
                                  child: _AuthImagePanel(
                                    titleKey: 'auth.sign_in_visual_title',
                                    subtitleKey:
                                        'auth.sign_in_visual_subtitle',
                                  ),
                                ),
                          ...
                          : ListView(
                              ...
                              children: [
                                _MobileHeader(
                                  title: 'auth.sign_in_title'.tr(),
                                  subtitle: 'auth.sign_in_subtitle'.tr(),
                                ),
    ...
    return Container(
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            _BackButtonRow(title: 'auth.sign_in'.tr()),
    ...
    return ClipRRect(
      ...
      child: Stack(
        ...
        children: [
          const PremiumImage(
            imageUrl:
                'https://images.unsplash.com/photo-1553913861-c0fddf2619ee?auto=format&fit=crop&w=1300&q=80',
            fit: BoxFit.cover,
          ),
          DecoratedBox(
            decoration: BoxDecoration(
